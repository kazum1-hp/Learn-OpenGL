...
//云RGBA图
#define RGBATex "tex/CloudRGBA_02.png"

//主色亮色_白天
float4 LightColor_Day = COLOR(230, 252, 255, 255);

//主色阴影色_白天
float4 ShadowColor_Day = COLOR(155, 206, 233, 255);
...
//云Noise图
#define NoiseTex "tex/NoiseRGB_01.png"
...
static const float4 SDFNoise_Mul = ST(1.0, 0.8, 1.3, 0.04);//xyzw对应行数乘算，速度乘算，程度乘算，过渡程度
