...
void Application::init()
{
	...
	auto model = res.LoadModel("../Assets/mid_century_lounge_chair/mid_century_lounge_chair_4k.gltf");
	...
	mainScene.AddPointLight(Light(glm::vec3(5.0f, 0.0f, 0.0f), glm::vec3(-4.0f, 0.5f, -3.0f), LightType::Point));
	mainScene.AddPointLight(Light(glm::vec3(0.0f, 0.0f, 14.0f), glm::vec3(3.0f, 0.5f, 1.0f), LightType::Point));
	mainScene.AddPointLight(Light(glm::vec3(0.0f, 2.0f, 0.0f), glm::vec3(-0.8f, 2.4f, -1.0f), LightType::Point));
